        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Proses Peminjaman</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form method="post" action="{{ url('processpeminjamans/'.$datapeminjaman->id_peminjaman) }}">
                @csrf
                @method('PUT')
                <input type="hidden" name="status" value="Process">
                <div class="card-body">
                  <div class="form-group">
                    <label for="kondisi_awal">Kondisi Awal</label><br/>
